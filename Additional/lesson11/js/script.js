window.addEventListener('DOMContentLoaded', function () {
    ...
    let feedbackSuccess = document.querySelector('.overlay-feedback__success'),
        closeFeedbackSuccess = feedbackSuccess.querySelector('.popup-close-feedback'),
        feedbackFail = document.querySelector('.overlay-feedback__fail'),
        closeFeedbackFail = feedbackFail.querySelector('.popup-close-feedback');
    ...
    closeFeedbackFail.addEventListener('click', () => {
        ...
        elem.addEventListener('submit', function (event) {
            ...
            request.addEventListener('readystatechange', function () {
                if (request.readyState < 4) {
                    ...
                    statusMessage.innerHTML = "<img src='img/ajax-loader1.gif'>";
